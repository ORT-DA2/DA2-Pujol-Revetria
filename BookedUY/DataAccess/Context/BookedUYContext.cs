...
namespace DataAccess.Context
{
    public class BookedUYContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasOne<User>(b => b.HeadGuest).WithMany(t => t.Bookings).HasForeignKey(b => b.GuestId);
            ...
            modelBuilder.Entity<User>().Property(a => a.isAdmin).IsRequired();
            modelBuilder.Entity<User>().Property(a => a.Name);
            ...
            modelBuilder.Entity<BookingStage>().HasOne<User>(a => a.Administrator).WithMany(b => b.Entries).HasForeignKey(s => s.AdministratorId);
